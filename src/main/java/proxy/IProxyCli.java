...
public interface IProxyCli {
	 ...
	 * <p/>
	 * Note that as long as there is any non-daemon thread alive, the application won't shut down, so you need to stop them. Therefore call
	 * {@link java.net.ServerSocket#close()}, which will throw a {@link java.net.SocketException} in the thread blocked in
	 * {@link java.net.ServerSocket#accept()}, and {@link java.net.DatagramSocket#close()}, which will throw a
	 * {@link java.net.SocketException} in the thread blocked in {@link java.net.DatagramSocket#receive(java.net.DatagramPacket)}.<br/>
	 ...
	 * {@link java.util.concurrent.ExecutorService#shutdown()} method and in case of a {@link java.util.Timer Timer}, call
	 * {@link java.util.Timer#cancel()}.
	 * <p/>
